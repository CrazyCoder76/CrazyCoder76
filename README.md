<h1 align="center">👋 Hello Gang, I'm Crazy Coder</h1>
...
<p>
  ...
  <img src="https://skillicons.dev/icons?i=jenkins" alt="icon" height="65" />
...
<details>
<summary style="font-size: 16px">🤖 AI-Powered Code Assistant</summary>
<p>
An intelligent code completion and suggestion tool built using transformer models and integrated with popular IDEs. Improves coding efficiency by 40%.
<br>
<strong>Tech Stack:</strong> Python, PyTorch, FastAPI, Docker
<br>
</p>
</details>

<details>
<summary style="font-size: 16px">🌐 Scalable Microservices Architecture</summary>
<p>
Designed and implemented a high-performance, scalable microservices architecture handling 1M+ daily active users.
<br>
<strong>Tech Stack:</strong> Go, gRPC, Kubernetes, PostgreSQL, Redis
<br>
</p>
</details>

<details>
<summary style="font-size: 16px">📊 Real-time Analytics Dashboard</summary>
<p>
A responsive web application providing real-time insights and visualizations for business metrics.
<br>
<strong>Tech Stack:</strong> React, Node.js, Socket.io, D3.js, MongoDB
<br>
</p>
</details>
